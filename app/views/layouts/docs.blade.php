...
<body id="index" class="page docs">
    	...
    	<nav id="primary">
    	    <div class="boxed">
                ...
                <ul>
                    ...
                    <li><a href="api" title="Laravel Framework API">API</a></li>
    ...
    <section id="copyright" class="textcenter">
        <div class="boxed">
            <div class="animated slideInLeft">Copyright &copy; 2013 <a href="//taylorotwell.com" title="Taylor Otwell" target="_blank">Taylor Otwell</a>. Website built with &hearts; <a href="//ikreativ.com" title="iKreativ" target="_blank">iKreativ</a>.</div>
        </div>
    </section>
    <!-- /copyright -->
